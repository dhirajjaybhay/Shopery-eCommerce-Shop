    ...
    <div className="pt-20">
      <div className="flex flex-col lg:flex-row pt-4">
        <div className="w-full">
          <div className=" pb-10 rounded-md pl-4 lg:pl-16">
            <img src="../assets/img/bannerImg.png" className="h-[100vh] w-full" alt="" />
          </div>
        </div>
      </div>
      ...
      <section>
        <div className="pt-20">
          ...
          <div className="flex justify-evenly flex-wrap -m-4 gap-5 md:gap-10 pt-10">
              ...
              <>
                ...
                >
                  <div className="flex justify-center">
                    <img
                      src={item.thumbnail}
                      className="h-56 w-80 rounded-t-md "
                      alt=""
                    />
                  </div>
      ...
      <section>
        <div className="pt-20">
          <div>
            <h1 className="text-3xl font-semibold">Best Selling Product</h1>
          </div>
              ...
              <>
                ...
                >
                  ...
                  <Link to={`/product/${item.id}`}>
                    <img src={item.thumbnail} className="h-80 w-full" alt="" />
                    </Link>
                  </div>
      ...
      <section
        ...
        className=" py-16 mt-10 sm:py-32"
      >
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="mx-auto max-w-2xl md:text-center">
            <h2 className=" text-3xl tracking-tight text-slate-900 sm:text-4xl font-semibold">
                ...
                <li>
                  <figure className="relative rounded-2xl bg-white p-6 shadow-xl shadow-slate-900/10">
                    ...
                    <blockquote className="relative">
                      ...
                      "This laptop product has truly elevated my productivity to new heights! Its high-quality display, efficient processing power, and lightweight design make it the perfect companion for both work and play. I'm thrilled with my purchase!"
              ...
              <ul role="list" className="flex flex-col gap-y-6 sm:gap-y-8">
                <li>
                  <figure className="relative rounded-2xl bg-white p-6 shadow-xl shadow-slate-900/10">
                    ...
                    <blockquote className="relative">
                      <p className="text-lg tracking-tight text-slate-900">
                      "I can't express how impressed I am with this laptop product! Its sleek design, lightning-fast performance, and exceptional battery life have made my work and entertainment experiences seamless and enjoyable. I highly recommend it to anyone in need of a reliable and powerful laptop."
                      </p>
                    </blockquote>
                    <figcaption className="relative mt-6 flex items-center justify-between border-t border-slate-100 pt-6">
                      <div>
              ...
              <ul role="list" className="flex flex-col gap-y-6 sm:gap-y-8">
                <li>
                  <figure className="relative rounded-2xl bg-white p-6 shadow-xl shadow-slate-900/10">
                    ...
                    <blockquote className="relative">
                      <p className="text-lg tracking-tight text-slate-900">
                      Wow! This mobile product has completely transformed the way I stay connected. Its sleek design and lightning-fast performance make it a must-have for anyone who wants to be ahead in the digital world. I can't imagine my life without it now!
                      </p>
                    </blockquote>
                    <figcaption className="relative mt-6 flex items-center justify-between border-t border-slate-100 pt-6">
                      <div>
